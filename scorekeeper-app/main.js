...
var author$project$Main$add = function (model) {
	var player = A3(
		...
		model.name,
		0);
	var newPlayers = A2(elm$core$List$cons, player, model.players);
...
var author$project$Main$Play = F4(
	function (playerId, id, name, points) {
			...
			[
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Attributes$placeholder('add'),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('Player_main')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('Player_name')
							]),
						_List_fromArray(
							[
		...
		_List_fromArray(
			[
				...
				A2(
					elm$core$List$map,
					function (player) {
						return author$project$Main$playerView(player);
					},
					model.players)),
				function () {
